...
var truckSaleEP: [Page] = [
    ...
    Page(index: 1, storyText: "당신은 길을 걷다가 파란 용달 트럭이 천천히 다가오는 것을 발견합니다. 트럭 짐칸엔 잡동사니가 가득 실려 있고, 활과 창으로 무장한 경호원 셋이 함께 타고 있습니다, 당신 앞에서 조수석 유리창이 내려가더니, 인상 좋은 남자 둘이 자신들을 서울역에서 온 상인이라고 소개하며 당신에게 가까이 와서 물건을 둘러보라고 합니다.", storyImage: nil, choice: [
            Choice(choiceText: "둘러본다", ability: [], abilityGive: true, health: 0, healthGive: true, mental: 0, mentalGive: true, money: 0, moneyGive: true, needAbility: nil, nextPageIndex: 1),
            Choice(choiceText: "그냥 간다", ability: [], abilityGive: true, health: 0, healthGive: true, mental: 0, mentalGive: true, money: 0, moneyGive: true, needAbility: nil, nextPageIndex: 6)
    ], endEpisodeNumber: 0),
    ...
    Page(index: 1, storyText: "둘러보니 별로 쓸모 있어 보이는 물건은 많지 않습니다. \"마음껏 둘러보십시오. 물건은 매번 바뀌니 언제든 또 찾아주시고요.\"", storyImage: nil, choice: [
            ...
            Choice(choiceText: "떠난다", ability: [], abilityGive: true, health: 0, healthGive: true, mental: 0, mentalGive: true, money: 0, moneyGive: true, needAbility: nil, nextPageIndex: 5)
    ], endEpisodeNumber: 0),
