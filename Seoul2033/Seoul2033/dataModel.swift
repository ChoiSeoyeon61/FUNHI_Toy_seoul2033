...
// 아래 유저의 플레이어 인스턴스
   ...
   var santaCharacter1: GameCharacter = GameCharacter(health: 3, mental: 3, money: 3, ability: [], currentEpPageIndex: 0, currentEpisode: truckSaleEP)
...
//                    // 한번 쉬고
//                    Page(index: 4, storyText: "잠깐만요, 물 한잔만 마시고 마저 얘기해드릴게요. 이거 오랜만에 말을 많이 하려니까 힘드네요. 혹시 벌써 지루하거나 그런건 아니죠? 당신 얘기라구요, 당신 얘기. 어쨌거나, 어디까지 얘기했죠?", choice: [Choice(choiceText: "제가 어떤 사람인지 더 알려주세요.", ability: [], abilityGive: true, health: 0, healthGive: true, mental: 0, mentalGive: true, money: 0, moneyGive: true, nextPageIndex: 0)]),
//                    //두번째 능력 받는 페이지
...
//                        Page(index: 5, storyText: "아, 당신은 기계를 조립하는 것을 정말 좋아했어요. 어릴 때부터 로봇 장난감은 진작에 졸업하고 어른들이 사용하는 기계나 공구에 관심을 가지기 시작했어요. 당신에게 공대생 기질이 다분한 것 같군요!", choice: [Choice(choiceText: "그나저나, 당신은 누구죠?", ability: [], abilityGive: true, health: 0, healthGive: true, mental: 0, mentalGive: true, money: 0, moneyGive: true, needAbility: nil, nextPageIndex: 5)]),
//                        Page(index: 6, storyText: "아, 그리고 당신은 엄청 날렵해요. 산 속의 온갖 불친절한 환경도 그다지 문제가 되지 않죠. 또래에 비해 항상 더 빨리 달리고, 높이 뛰고, 가벼웠어요. 어른들이 당신은 산 속에서 뭘 만나도 무사히 살아돌아올거라 생각할 정도죠. /n술래잡기는 당신이 제일 좋아하는 놀이입니다.", choice: [Choice(choiceText: "그나저나, 당신은 누구죠?", ability: [], abilityGive: true, health: 0, healthGive: true, mental: 0, mentalGive: true, money: 0, moneyGive: true, needAbility: nil, nextPageIndex: 5)]),
...
//                    Page(index: 6, storyText: "당신은 들뜬 마음으로 집 곳곳을 돌아다니다가 헛간의 문을 열었습니다. 그런데 그곳에는… 이런!", choice: [Choice(choiceText: "엄마? 아빠?", ability: [], abilityGive: true, health: 0, healthGive: true, mental: 1, mentalGive: false, money: 0, moneyGive: true, nextPageIndex: 7)]),
...
//                    Page(index: 8, storyText: "이런 세상에서 사람 몇 명 죽는건 그다지 놀랄만한 일이 아닙니다만, 여태까지 평화롭던 이 마을에서 살인 사건이 일어났단 사실은 마을 사람 모두에게 충격을 안겨줬습니다. 그러나 목격자는커녕 총성조차 들은 사람이 없습니다. 특이한 점은 어머니가 평소 하고 계시던 십자가 목걸이가 사라졌다는 것뿐입니다.", choice: [Choice(choiceText: "다음", ability: [], abilityGive: true, health: 0, healthGive: true, mental: 0, mentalGive: true, money: 0, moneyGive: true, nextPageIndex: 9)]),
//                    Page(index: 9, storyText: "슬픔, 분노, 그리고 두려움이 마을을 뒤덮었습니다. 범인을 색출해내고 마을을 지키기 위해서 자경대가 조직되었습니다. 모든 집들이 샅샅이 수색되었으며, 사람들이 이제 철문과 빗장을 달고 열쇠와 창을 만들기 시작했습니다. 학교는 문을 닫았고 아이들은 집 밖으로 나가는 것이 금지되었습니다.", choice: [Choice(choiceText: "나는...", ability: [], abilityGive: true, health: 0, healthGive: true, mental: 0, mentalGive: true, money: 0, moneyGive: true, nextPageIndex: 10)]),
//                    Page(index: 10, storyText: "쟁기는 칼이 되었고, 사람들은 겉으로는 괜찮은 척 하지만 속으로는 서로를 믿지 못했으며, 마을은 요새가 되어가고 있었습니다. 온화하던 부동산 아저씨는 도심으로 내려가 총을 구해야 한다고 말했고, 밤중에 마을을 떠나려고 곡식을 몰래 챙겨두던 청년이 붙잡혀 마을 회관 쪽방에 갇혔습니다.", choice: [Choice(choiceText: "나는 나가서 놈을 찾아낼거야.", ability: [], abilityGive: true, health: 0, healthGive: true, mental: 0, mentalGive: true, money: 0, moneyGive: true, nextPageIndex: 11)]),
...
//                    Page(index: 12, storyText: "마을 사람들에게 작별 인사를 마친 뒤, 당신은 생애 처음으로 철근과 콘크리트가 우거진 서울의 폐허를 향해 발걸음을 내딛었습니다. 복잡하고 무거운 마음도 크지만 호기심과 궁금증으로 가슴이 뛰는 것도 느껴집니다. /n지금부터 당신의 모험이 시작됩니다.",storyImage: "tutorialSeoulImage", choice: [Choice(choiceText: "좋아, 가보자!", ability: [], abilityGive: true, health: 0, healthGive: true, mental: 0, mentalGive: true, money: 0, moneyGive: true, nextPageIndex: 0)])
//    ]
//var woodEP: [Page] = [
//
...
//                  Choice(choiceText: "목자재를 치운다", ability: [], abilityGive: true, health: 1, healthGive: false, mental: 0, mentalGive: true, money: 0, moneyGive: true, needAbility: nil, nextPageIndex: 1),
//                  Choice(choiceText: "그냥 간다", ability: [], abilityGive: true, health: 0, healthGive: true, mental: 0, mentalGive: true, money: 0, moneyGive: true, needAbility: nil,nextPageIndex: 2)
//            ], endEpisodeNumber: 1),
//
...
//          Choice(choiceText: "다음", ability: [], abilityGive: true, health: 0, healthGive: true, mental: 0, mentalGive: true, money: 0, moneyGive: true, needAbility: nil, nextPageIndex: 666)
...
var truckSaleEP: [Page] = [
    ...
    Page(index: 1, storyText: "둘러보니 별로 쓸모 있어 보이는 물건은 많지 않습니다. \"마음껏 둘러보십시오. 물건은 매번 바뀌니 언제든 또 찾아주시고요.\"", storyImage: nil, choice: [
            ...
            Choice(choiceText: "<스피치로 승부하라>", ability: [.book_speech], abilityGive: true, health: 0,  mental: -2,  money: -1,  needAbility: nil, nextPageIndex: 4),
