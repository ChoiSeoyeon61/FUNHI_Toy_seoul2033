...
func getRandomNumber(randomStartNum : Int, randomFinishNum: Int ) -> Int {
...
//func getRandomNumber(currentPage : Page 지금까지 방문했던 페이지 배열) - {
//    //튜토리얼에서 무작위 수 받기
//
//    만약 에피소드의 마지막 페이지가 맞다면 {
//        새에피번호 = 전체에피번호
//        캐릭터_현재에피소드 = 전체에피[새에피번호]
//    }
//    if currentPage.currentPageNumber == 3  {
...
let prologueEP : [Page] = [
    ...
    Page(index: 4, storyText: "아, 그리고 당신은 영어를 할 줄 알아요! 이 마을에도 아이들을 위한 학교는 있는데, 선생님께서 영어를 가르쳐야 하나 말아야 하나 무척 고민이 깊으셨다고 해요. 사실 한국 교육과정이란게 영어가 필수긴 한데, 수능도 토익도 없어진 마당에 영어를 꼭 가르쳐야 할까요? 그런데 우연히 당신이 큰 관심을 가지는 것을 보고 당신에게만 개인 과외를 해주셨죠. 쓸모 있는 지식인진 정말 모르겠네요. ", choice: [Choice(choiceText: "그나저나, 당신은 누구죠?", ability: [], abilityGive: true, health: 0,  mental: 0,  money: 0, needAbility: nil, nextPageIndex: 10)]),
                        Page(index: 5, storyText: "아, 당신은 기계를 조립하는 것을 정말 좋아했어요. 어릴 때부터 로봇 장난감은 진작에 졸업하고 어른들이 사용하는 기계나 공구에 관심을 가지기 시작했어요. 당신에게 공대생 기질이 다분한 것 같군요!", choice: [Choice(choiceText: "그나저나, 당신은 누구죠?", ability: [], abilityGive: true, health: 0,  mental: 0,  money: 0,  needAbility: nil, nextPageIndex: 10)]),
                        Page(index: 6, storyText: "아, 그리고 당신은 엄청 날렵해요. 산 속의 온갖 불친절한 환경도 그다지 문제가 되지 않죠. 또래에 비해 항상 더 빨리 달리고, 높이 뛰고, 가벼웠어요. 어른들이 당신은 산 속에서 뭘 만나도 무사히 살아돌아올거라 생각할 정도죠. /n술래잡기는 당신이 제일 좋아하는 놀이입니다.", choice: [Choice(choiceText: "그나저나, 당신은 누구죠?", ability: [], abilityGive: true, health: 0,  mental: 0,  money: 0,  needAbility: nil, nextPageIndex: 10)]),
                    Page(index: 5, storyText: "저는 당신의 이야기의 이야기꾼이에요. 사실 지금부터 본격적인 이야기가 시작되거든요. 오늘은 당신의 18번째 생일인데, 심부름을 나갔다가 돌아오니 어찌 된 일인지 가족들이 아무도 보이지 않는군요.", storyImage: nil, choice: [Choice(choiceText: "서프라이즈 파티?", ability: [], abilityGive: true, health: 0,  mental: 0,  money: 0, needAbility: nil, nextPageIndex: 6), Choice(choiceText: "저 이야기 알아요! 넘어가자구요.", ability: [], abilityGive: true, health: 0, mental: -1,  money: 0,  needAbility: nil, nextPageIndex: 12)]),
                    Page(index: 6, storyText: "당신은 들뜬 마음으로 집 곳곳을 돌아다니다가 헛간의 문을 열었습니다. 그런데 그곳에는… 이런!", choice: [Choice(choiceText: "엄마? 아빠?", ability: [], abilityGive: true, health: 0,  mental: -1,  money: 0, nextPageIndex: 7)]),
                    Page(index: 7, storyText: "정말로 가족들은 당신을 위한 서프라이즈 파티를 준비하고 있었던 같아 보입니다. 분명히 생일상도 차려져 있었구요. 그러나 당신보다 먼저 문을 열고 들어온 것은 어떤 악마 같은 자였음이 틀림 없습니다. 난장판이 된 헛간 안에 덩그러니 남겨져 있는 것은…. 총에 맞아 피투성이가 된 가족들의 시체뿐이었습니다.",storyImage: "parentsCorpse", choice: [Choice(choiceText: "다음", ability: [], abilityGive: true, health: 0, mental: 0, money: 0,  nextPageIndex: 8)]),
                    Page(index: 8, storyText: "이런 세상에서 사람 몇 명 죽는건 그다지 놀랄만한 일이 아닙니다만, 여태까지 평화롭던 이 마을에서 살인 사건이 일어났단 사실은 마을 사람 모두에게 충격을 안겨줬습니다. 그러나 목격자는커녕 총성조차 들은 사람이 없습니다. 특이한 점은 어머니가 평소 하고 계시던 십자가 목걸이가 사라졌다는 것뿐입니다.", choice: [Choice(choiceText: "다음", ability: [], abilityGive: true, health: 0, mental: 0, money: 0,  nextPageIndex: 9)]),
                    Page(index: 9, storyText: "슬픔, 분노, 그리고 두려움이 마을을 뒤덮었습니다. 범인을 색출해내고 마을을 지키기 위해서 자경대가 조직되었습니다. 모든 집들이 샅샅이 수색되었으며, 사람들이 이제 철문과 빗장을 달고 열쇠와 창을 만들기 시작했습니다. 학교는 문을 닫았고 아이들은 집 밖으로 나가는 것이 금지되었습니다.", choice: [Choice(choiceText: "나는...", ability: [], abilityGive: true, health: 0, mental: 0,  money: 0,  nextPageIndex: 10)]),
                    Page(index: 10, storyText: "쟁기는 칼이 되었고, 사람들은 겉으로는 괜찮은 척 하지만 속으로는 서로를 믿지 못했으며, 마을은 요새가 되어가고 있었습니다. 온화하던 부동산 아저씨는 도심으로 내려가 총을 구해야 한다고 말했고, 밤중에 마을을 떠나려고 곡식을 몰래 챙겨두던 청년이 붙잡혀 마을 회관 쪽방에 갇혔습니다.", choice: [Choice(choiceText: "나는 나가서 놈을 찾아낼거야.", ability: [], abilityGive: true, health: 0, mental: 0, money: 0, nextPageIndex: 11)]),
                    Page(index: 11, storyText: "당신이 직접 마을을 떠나서 범인을 잡겠다고 했을 때, 마을 사람들은 저마다 복잡한 생각으로 가득찬 것 같아 보였습니다. 다들 밖은 위험한 것을 알지만, 선뜻 당신을 붙잡으려 하려는 이는 없습니다. 살인자는 아직도 당신을 노리고 있는 것은 아닐까요? 당신이 떠나면, 마을은 다시 불안에 떨지 않아도 되는 것 아닐까요? 짐을 들고 홀연히 서있는 당신에게 폐품업자 김 씨가 다가와 당신의 어깨를 붙잡고 말합니다. \"서울은 네가 생각했던 것보다 훨씬 더 끔찍하고 불친절할거다. 영문도 모른 채 다치고, 빼앗기고, 죽을 수도 있어. 너에게 불가능한 것을 요구할 수도 있고, 너가 약하다고 해서 봐주지도 않을거다. 그러니 살아남으려면 어떻게 쓸만한 것을 모으고, 능력을 길러라. 그리고 무엇보다, 다시 시작하는 걸 두려워하지 말거라\"", choice: [Choice(choiceText: "명심하겠습니다.", ability: [], abilityGive: false, health: 0,  mental: 0, money: 0, needAbility: nil, nextPageIndex: 12)]),
                    Page(index: 12, storyText: "마을 사람들에게 작별 인사를 마친 뒤, 당신은 생애 처음으로 철근과 콘크리트가 우거진 서울의 폐허를 향해 발걸음을 내딛었습니다. 복잡하고 무거운 마음도 크지만 호기심과 궁금증으로 가슴이 뛰는 것도 느껴집니다. /n지금부터 당신의 모험이 시작됩니다.",storyImage: "tutorialSeoulImage", choice: [Choice(choiceText: "좋아, 가보자!", ability: [], abilityGive: true, health: 0, mental: 0, money: 0, nextPageIndex: 0)])
    ]
var woodEP: [Page] = [
        ...
        Page(index: 1, storyText: "무너진 목자재 아래에 긴급 구호 물품 상자가 깔려 있는 것이 보입니다! 저것들만 치우면 꺼낼 수 있겠는데요, 생각보다 무거워 보여서 자칫 잘못했다간 허리만 나갈 것 같습니다. ", storyImage: nil, choice: [
            Choice(choiceText: "목자재를 치운다", ability: [], abilityGive: true, health: -1,  mental: 0,money: 0,  needAbility: nil, nextPageIndex: 1),
                  Choice(choiceText: "그냥 간다", ability: [], abilityGive: true, health: 0, mental: 0, money: 0,  needAbility: nil,nextPageIndex: 2)
            ], endEpisodeNumber: 1),
        ...
        Page(index: 1, storyText: "운동을 좀 헤둘 걸 그랬나요? 당신은 낑낑대며 목재 더미와 씨름하다가 그만 힘을 잘못 줘서 허리에 큰 부담이 오고 말았습니다. 한동안 걷기 힘들 정도로 고통이 상당합니다. 당신은 나무 더미를 향해 저주를 퍼붓다가 이내 포기합니다..", storyImage: nil, choice: [
          Choice(choiceText: "다음", ability: [], abilityGive: true, health: 0, mental: 0, money: 0, needAbility: nil, nextPageIndex: 666)
...
var truckSaleEP: [Page] = [
    ...
    Page(index: 1, storyText: "당신은 길을 걷다가 파란 용달 트럭이 천천히 다가오는 것을 발견합니다. 트럭 짐칸엔 잡동사니가 가득 실려 있고, 활과 창으로 무장한 경호원 셋이 함께 타고 있습니다, 당신 앞에서 조수석 유리창이 내려가더니, 인상 좋은 남자 둘이 자신들을 서울역에서 온 상인이라고 소개하며 당신에게 가까이 와서 물건을 둘러보라고 합니다.", storyImage: nil, choice: [
            Choice(choiceText: "둘러본다", ability: [], abilityGive: true, health: 0,  mental: 0, money: 0,  needAbility: nil, nextPageIndex: 1),
            Choice(choiceText: "그냥 간다", ability: [], abilityGive: true, health: 0,  mental: 0,  money: 0,  needAbility: nil, nextPageIndex: 6)
    ], endEpisodeNumber: 0),
    
    //선택지 둘러본다
    Page(index: 1, storyText: "둘러보니 별로 쓸모 있어 보이는 물건은 많지 않습니다. \"마음껏 둘러보십시오. 물건은 매번 바뀌니 언제든 또 찾아주시고요.\"", storyImage: nil, choice: [
            Choice(choiceText: "살충제", ability: [.insecticide], abilityGive: true, health: 0,  mental: 0,  money: -1,  needAbility: nil, nextPageIndex: 2),
            Choice(choiceText: "붕대와 부목", ability: [.bandage, .splint], abilityGive: true, health: 0,  mental: 0, money: -1,  needAbility: nil, nextPageIndex: 3),
            Choice(choiceText: "<스피치로 승부하라>", ability: [.bookSpeech], abilityGive: true, health: 0,  mental: -2,  money: -1,  needAbility: nil, nextPageIndex: 4),
            Choice(choiceText: "떠난다", ability: [], abilityGive: true, health: 0,  mental: 0, money: 0,  needAbility: nil, nextPageIndex: 5)
    ], endEpisodeNumber: 0),
