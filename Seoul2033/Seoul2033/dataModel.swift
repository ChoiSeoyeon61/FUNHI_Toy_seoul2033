...
let prologueEP : [Page] = [
    ...
    Page(index: 1, storyText: "당신은 마을의 엄청난 말썽꾸러기이자 골목대장이었어요. 산 곳곳을 매일 뛰어다니고 온갖 사고를 치고 다녔고, 가끔씩 애들을 이끌고 다른 골목 아이들과 쌈박질을 하곤 했어요. 리더로 산다는 것은 확실히 피곤한 일이긴 하지만.. 뭐, 당신은 그걸 꽤 좋아했던 것 같네요. 나이 먹으면서 더 이상 그런 짓들은 안 하지만 당신은 여전히 마을 아이들의 우상입니다. ", choice: [Choice(choiceText: "그렇군요! 또 뭐 없나요?", ability: [], abilityGive: true, health: 0,  mental: 0,  money: 0,  nextPageIndex: 6)]),
                    ...
                    // 한번 쉬고
                    Page(index: 4, storyText: "잠깐만요, 물 한잔만 마시고 마저 얘기해드릴게요. 이거 오랜만에 말을 많이 하려니까 힘드네요. 혹시 벌써 지루하거나 그런건 아니죠? 당신 얘기라구요, 당신 얘기. 어쨌거나, 어디까지 얘기했죠?", choice: [Choice(choiceText: "제가 어떤 사람인지 더 알려주세요.", ability: [], abilityGive: true, health: 0,  mental: 0,  money: 0,  nextPageIndex: getRandomPageNumber(randomStartNum: 7, randomFinishNum: 9))]),
                    //두번째 능력 받는 페이지
    Page(index: 4, storyText: "아, 그리고 당신은 영어를 할 줄 알아요! 이 마을에도 아이들을 위한 학교는 있는데, 선생님께서 영어를 가르쳐야 하나 말아야 하나 무척 고민이 깊으셨다고 해요. 사실 한국 교육과정이란게 영어가 필수긴 한데, 수능도 토익도 없어진 마당에 영어를 꼭 가르쳐야 할까요? 그런데 우연히 당신이 큰 관심을 가지는 것을 보고 당신에게만 개인 과외를 해주셨죠. 쓸모 있는 지식인진 정말 모르겠네요. ", choice: [Choice(choiceText: "그나저나, 당신은 누구죠?", ability: [], abilityGive: true, health: 0,  mental: 0,  money: 0, needAbility: nil, nextPageIndex: 10)]),
                    ...
                    Page(index: 5, storyText: "저는 당신의 이야기의 이야기꾼이에요. 사실 지금부터 본격적인 이야기가 시작되거든요. 오늘은 당신의 18번째 생일인데, 심부름을 나갔다가 돌아오니 어찌 된 일인지 가족들이 아무도 보이지 않는군요.", storyImage: nil, choice: [Choice(choiceText: "서프라이즈 파티?", ability: [], abilityGive: true, health: 0,  mental: 0,  money: 0, needAbility: nil, nextPageIndex: 11), Choice(choiceText: "저 이야기 알아요! 넘어가자구요.", ability: [], abilityGive: true, health: 0, mental: -1,  money: 0,  needAbility: nil, nextPageIndex: 666)]),
                    Page(index: 6, storyText: "당신은 들뜬 마음으로 집 곳곳을 돌아다니다가 헛간의 문을 열었습니다. 그런데 그곳에는… 이런!", choice: [Choice(choiceText: "엄마? 아빠?", ability: [], abilityGive: true, health: 0,  mental: -1,  money: 0, nextPageIndex: 12)]),
                    Page(index: 7, storyText: "정말로 가족들은 당신을 위한 서프라이즈 파티를 준비하고 있었던 같아 보입니다. 분명히 생일상도 차려져 있었구요. 그러나 당신보다 먼저 문을 열고 들어온 것은 어떤 악마 같은 자였음이 틀림 없습니다. 난장판이 된 헛간 안에 덩그러니 남겨져 있는 것은…. 총에 맞아 피투성이가 된 가족들의 시체뿐이었습니다.",storyImage: "parentsCorpse", choice: [Choice(choiceText: "다음", ability: [], abilityGive: true, health: 0, mental: 0, money: 0,  nextPageIndex: 13)]),
                    Page(index: 8, storyText: "이런 세상에서 사람 몇 명 죽는건 그다지 놀랄만한 일이 아닙니다만, 여태까지 평화롭던 이 마을에서 살인 사건이 일어났단 사실은 마을 사람 모두에게 충격을 안겨줬습니다. 그러나 목격자는커녕 총성조차 들은 사람이 없습니다. 특이한 점은 어머니가 평소 하고 계시던 십자가 목걸이가 사라졌다는 것뿐입니다.", choice: [Choice(choiceText: "다음", ability: [], abilityGive: true, health: 0, mental: 0, money: 0,  nextPageIndex: 14)]),
                    Page(index: 9, storyText: "슬픔, 분노, 그리고 두려움이 마을을 뒤덮었습니다. 범인을 색출해내고 마을을 지키기 위해서 자경대가 조직되었습니다. 모든 집들이 샅샅이 수색되었으며, 사람들이 이제 철문과 빗장을 달고 열쇠와 창을 만들기 시작했습니다. 학교는 문을 닫았고 아이들은 집 밖으로 나가는 것이 금지되었습니다.", choice: [Choice(choiceText: "나는...", ability: [], abilityGive: true, health: 0, mental: 0,  money: 0,  nextPageIndex: 15)]),
                    Page(index: 10, storyText: "쟁기는 칼이 되었고, 사람들은 겉으로는 괜찮은 척 하지만 속으로는 서로를 믿지 못했으며, 마을은 요새가 되어가고 있었습니다. 온화하던 부동산 아저씨는 도심으로 내려가 총을 구해야 한다고 말했고, 밤중에 마을을 떠나려고 곡식을 몰래 챙겨두던 청년이 붙잡혀 마을 회관 쪽방에 갇혔습니다.", choice: [Choice(choiceText: "나는 나가서 놈을 찾아낼거야.", ability: [], abilityGive: true, health: 0, mental: 0, money: 0, nextPageIndex: 16)]),
                    ...
                    Page(index: 12, storyText: "마을 사람들에게 작별 인사를 마친 뒤, 당신은 생애 처음으로 철근과 콘크리트가 우거진 서울의 폐허를 향해 발걸음을 내딛었습니다. 복잡하고 무거운 마음도 크지만 호기심과 궁금증으로 가슴이 뛰는 것도 느껴집니다. \n지금부터 당신의 모험이 시작됩니다.",storyImage: "tutorialSeoulImage", choice: [Choice(choiceText: "좋아, 가보자!", ability: [], abilityGive: true, health: 0, mental: 0, money: 0, nextPageIndex: 666)])
    ]
var woodEP: [Page] = [
